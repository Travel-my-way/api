...
class Client(Celery):
    ...
    def init_app(self, settings: Settings):
        ...
        # List of workers
        self.workers = settings.workers.split(',')

    def publish_journey(self, journey: Journey) -> AsyncResult:
        logger.info(f"Emitting: {journey} to {self.workers} workers")
